...
import * as ConfigContract from "@sentry-tui/runtime-contract/config";
import {
  HOST_API_VERSION,
  HOST_MODULE_SPECIFIERS,
  type AppPayloadManifest,
  type AppPayloadMetadata,
} from "@sentry-tui/runtime-contract/runtime";
import * as TelemetryContract from "@sentry-tui/runtime-contract/telemetry";
import * as UpdateContract from "@sentry-tui/runtime-contract/update";
import "@sentry-tui/runtime-host/config/index";
import "@sentry-tui/runtime-host/telemetry/index";
import "@sentry-tui/runtime-host/update/selfUpdate";
import type { PayloadAppProps } from "@sentry-tui/app/payloadEntry";
...
const HOST_MODULES = new Map<string, Record<string, unknown>>([
  ...
  [HOST_MODULE_SPECIFIERS["@sentry-tui/runtime-contract/config"], ConfigContract],
  [HOST_MODULE_SPECIFIERS["@sentry-tui/runtime-contract/telemetry"], TelemetryContract],
  [HOST_MODULE_SPECIFIERS["@sentry-tui/runtime-contract/update"], UpdateContract],
]);
