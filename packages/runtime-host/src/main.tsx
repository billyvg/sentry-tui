...
import { runLogin, runLogout, runStatus } from "@sentry-tui/runtime-host/startup/login";
import {
  bootstrap,
...
import { runApp } from "@sentry-tui/runtime-host/ui/runApp";
...
// see `packages/runtime-host/src/telemetry/config.ts`.
await initTelemetry();
installCrashHandlers();
