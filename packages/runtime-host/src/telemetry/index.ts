...
import { isCompiledBinary, resolveTelemetry } from "@sentry-tui/runtime-host/telemetry/config";
import { parameterizePath, safeQuery, scrubEvent } from "@sentry-tui/runtime-host/telemetry/scrub";
 ...
 * (the runtime host's config service), so this costs no request. A personal-token user has
